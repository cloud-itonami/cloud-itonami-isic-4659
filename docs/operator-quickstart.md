# Operator Quickstart — Wholesale of other machinery and equipment

Shortest path from clone to a verified local dry-run for **ISIC 4659** (`cloud-itonami-isic-4659`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-4659.git
cd cloud-itonami-isic-4659
```
...
- Blueprint governor key: `precision-machinery-export-governor`
- Likely source path: `machtooltrade.governor.cljc`
