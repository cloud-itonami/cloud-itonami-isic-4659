...
(deftest delivery-dispatch-never-auto-at-any-phase
  (testing "structural invariant: no phase, now or in any future entry, auto-commits a real physical dispatch"
...
(deftest phase-3-auto-commits-only-no-capital-risk-ops
  (testing ":order/intake carries no direct capital/export-control risk -- auto-eligible; it is the ONLY auto-eligible op in this domain"
